	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">管理者账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.guanlizhezhanghao" 
				...
				<div class="list_item">
					<div class="list_label">管理者姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.guanlizhexingming" 
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.guanlizhezhanghao)){
		...
		if((!registerForm.value.guanlizhexingming)){
